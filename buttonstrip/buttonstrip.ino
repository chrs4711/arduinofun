...
void setup()
{
  ...
  strip.begin();
  strip.setBrightness(32); // 31, 63, 95, 127, 159, 191, 223, 255
  strip.show();
...
void cylon(int dur)
{
  ...
  strip.clear();
  strip.setPixelColor(strip.numPixels() - 2, 138, 55, 82);
  ...
  {
    strip.clear();
    strip.setPixelColor(i - 2, 138, 55, 82);
    strip.setPixelColor(i - 1, 48, 19, 44);
    strip.setPixelColor(i, 10, 4, 6);
    strip.show();
    delay(dur);
  }
